# Source text extracted from https://gaplaw.eu

Extracted: 2026-08-04  
Rule for the new site: use ONLY this content (and translations already present on the old site). Do not invent partners, stats, addresses, phones, or news.
...
| BG | EN | URL (BG) | URL (EN) |
|---|---|---|---|
| НАЧАЛО | Home | `/` or `/index.php` | `/index.php/en/` |
| ЗА НАС | About Us | `/index.php/about-us-2` | `/index.php/en/about-us-3` |
| СФЕРИ НА ДЕЙНОСТ | Services | `/index.php/services-3` | `/index.php/en/services-2` |
| НОВИНИ | News | `/index.php/faq-3` | `/index.php/en/faq-2` |
| КОНТАКТИ | Contact Us | `/index.php/contact-us-2` | `/index.php/en/contact-us-3` |

Languages: Bulgarian (default) + English (flag switcher).

---

## Shared contact / firm identity

- **Firm name (BG):** Адвокатско дружество Горанова и Христова-Аличкова  
- **Firm name (EN):** Goranova & Hristova – Alitchkova Law Firm  
- **Logo text:** Goranova & Hristova - Alitchkova  
- **Phone:** +359 888 71 0909  
- **Header line:** Legal consulting: Tel: +359 888 71 0909, mail: office@gaplaw.eu  
- **Office email:** office@gaplaw.eu  
- **Maria email:** maria.goranova@gaplaw.eu  
- **Gergana email:** gergana.alitchkova@gaplaw.eu  

### Address (BG)

```
1309 София, България
Ул. Царибродска №94, ет.3, офис 5
mail: office@gaplaw.eu
```

### Address (EN)

```
94 Tsaribrodska Street., floor 3, office 5
1309 Sofia, Republic of Bulgaria
mail: office@gaplaw.eu
```
...
### Partners (contact cards)

**Мария Горанова / Maria Goranova**  
- BG role: Адвокат — Дружествено право, Обществени поръчки  
- EN role: Attorney-at-Law — Company law, Public Procurement  
- mail: maria.goranova@gaplaw.eu  

**Гергана Христова - Аличкова / Gergana Hristova – Alitchkova**  
- BG role: Адвокат — Представител по индустриална собственост  
- EN role: Attorney-at-Law (L.L.M. Cologne, Germany) — Bulgarian & European IPR Attorney  
- mail: gergana.alitchkova@gaplaw.eu  
...
Адвокатско дружество Горанова и Христова-Аличкова е естествен резултат на многогодишно сътрудничество. То обединява различните познания и опит на партньорите в едно общо разбиране за това как трябва да бъдат осъществявани правни услуги. Нашият юридически екип вярва, че клиентът се нуждаe от всеобхватeн, компетентeн, индивидуален, навременен и бизнес ориентиран съвет, достатъчно добър, за да може клиентът да вземе собствено, обосновано бизнес решение.
...
Only two partners exist on the old site: Gergana Hristova-Alitchkova and Maria Goranova. No third partner.

### Gergana Hristova – Alitchkova (BG)
...
### Gergana Hristova – Alitchkova (EN)
...
Мария има обширни познания и практически опит в процедурите за възлагане на обществени поръчки в България – правни консултации, обжалване и процесуално представителство пред Комисията за защита на конкуренцията и Върховния Административен съд.

Мария се специализира в предоставянето на правни консултации и услуги по корпоративно право, административно право и обществени поръчки. Тя използва английски език.
...
Maria has extensive knowledge and practical experience in public procurement procedures in Bulgaria – legal consultations, appeal and litigation before the Commission for Protection of Competition and Supreme Administrative Court.

Maria is specialized in provision of legal consultations and services in corporate law, administrative law and public procurement. She speaks English.

---

## 3. Services / Сфери на дейност

### Bulgarian practice areas
...
- Advice and legal assistance on the appropriate forms of business cooperation, preparation of required legal documents for participation in tenders and compliance with tender requirements
- Legal analysis of acts of the Contracting Authority (for opening, termination, temporary closing or final act for choosing of contractor of the public tender) and estimation of the legal possibilities for appealing
- Appeal and legal representation against Contracting Authority’s acts before the Commission for Protection of Competition and /or the Supreme Administrative Court, including applying for imposing of temporary measures and litigation on behalf of interested parties
...
On-site news are mostly titles linking to PDF downloads (no long HTML article bodies). Titles and files:

1. **Пререгистрация на Сдружения и Фондации в светлината на сроковете за ГФО 2017 г. или неизвършвана дейност през 2017 г.**  
   PDF: https://gaplaw.eu/images/Novini/All_clients_letter_NGO-preregistration--no-activity-2017.pdf

2. **Общ Регламент за Защита на Личните данни - основни положения при подготовката за съответствие**  
   PDF: https://gaplaw.eu/images/Novini/Information_Letter_GDPR-Jan_2018.pdf

3. **Промени през 2018 г. за лица, неизвършващи дейност**  
   PDF: https://gaplaw.eu/images/Novini/All_clients_letter_29.11.2017_GoranovaHristova-Alitchkova_Law_Firm.pdf

4. **Промени в Търговския закон, в сила през 2017 г., от значение за ООД / ЕООД**  
   Related/extra PDF on page: https://gaplaw.eu/images/GAP_law_presentation_BNI_21_02_2017_vf.pdf (labeled „Презентация“)

5. **ГФО 2015** — https://gaplaw.eu/images/GFO__2015_GAP_law_21-04-2016-vf.pdf  
   **Решение** — https://gaplaw.eu/images/Decision_GM__GFO_2015-GAP_law.pdf

Note: The current repo `lib/content.ts` insights (2024–2025 ESG/NPO articles) are **not** from gaplaw.eu and must not be used if the rule is “exact info ONLY”.

---

## 5. Not present on the old site (do not invent / remove from new site)

These appear in the current Next.js repo but were **not** found on https://gaplaw.eu:

- Phone `+359 2 812 34 56` (real phone is `+359 888 71 0909`)
- Address `ул. „Иван Вазов“ 12` (real address is `Ул. Царибродска №94, ет.3, офис 5, 1309 София`)
- Third team member `адв. Даниел Петров`
- Stats such as `15+`, `200+`, `100%`
- Invented homepage marketing lines (ESG, Spanish language, etc.)
- Invented insights in `lib/content.ts`
- Working hours `09:00 – 18:30` (not stated on old site)
- LinkedIn company URL / metro station note (not stated on old site)

---

## Contact form note

Old contact page embeds a Wufoo form with placeholder marketing text (“Fill out my online form. / There are tons of Wufoo features…”). That Wufoo boilerplate is platform chrome, not firm content.
